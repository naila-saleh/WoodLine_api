...
using WoodLine.DAL.Utilities;
using WoodLine.PL.Middleware;
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("DefaultCorsPolicy", policy =>
    {
        policy.WithOrigins("http://localhost:5173")
              ...
              .AllowAnyMethod()
              .AllowCredentials();
        policy.WithOrigins("https://woodline.onrender.com")
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials();
        ;
